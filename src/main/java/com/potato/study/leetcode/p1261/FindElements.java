package com.potato.study.leetcode.p1261;
...
public class FindElements {
    ...
    private boolean findTarget(int target, TreeNode root) {
        if (root == null) {
            return false;
        }
        if (root.val == target) {
        ...
        return findTarget(target, root.left) || findTarget(target, root.right);
    }
