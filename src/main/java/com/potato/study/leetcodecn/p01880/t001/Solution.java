package com.potato.study.leetcodecn.p01880.t001;
...
public class Solution {
    ...
    public boolean isSumEqual(String firstWord, String secondWord,
            String targetWord) {
        long num1 = getNum(firstWord);
        long num2 = getNum(secondWord);
        long target = getNum(targetWord);
    ...
    public static void main(String[] args) {
        ...
        boolean result = solution.isSumEqual(firstWord, secondWord, targetWord);
